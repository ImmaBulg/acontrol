...
<div class="page-header">
	<?php if (Yii::$app->user->can('TenantManagerOwner')): ?>
				...
				Dropdown::widget([
					'items' => [
						[
							...
							'url' => ArrayHelper::merge(Yii::$app->request->get(), ['/client/tenant-create', 'id' => $model->id]),
						],
					],
				]); ?>
			</div>
...
<?php $form_active = ActiveForm::begin([
	...
	'method' => 'GET',
	'action' => ['/client/tenants', 'id' => $model->id],
]); ?>
<fieldset>
	<?php if (Yii::$app->user->can('TenantManagerOwner')): ?>
