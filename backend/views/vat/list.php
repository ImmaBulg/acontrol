...
use backend\models\searches\models\Vat;

$this->title = Yii::t('backend.view', 'VAT');
$this->params['breadcrumbs'][] = Yii::t('backend.view', 'VAT');
?>
<div class="page-header">
	<?php if (Yii::$app->user->can('VatManager')): ?>
		<div class="btn-toolbar pull-right">
			<div class="btn-group">
				...
				Dropdown::widget([
					'items' => [
						[
							'label' => Yii::t('backend.view', 'Add new VAT'),
							'url' => ArrayHelper::merge(Yii::$app->request->get(), ['/vat/create']),
						],
					],
				]); ?>
			</div>
...
<?php echo GridView::widget([
	...
	'columns' => [
		...
		[
			'attribute' => 'modificator_name',
			'value' => 'relationUserModificator.name',
		],
		[
			'format' => 'raw',
			'value' => function ($model){
				...
				if (Yii::$app->user->can('VatManager')) {
								...
								Dropdown::widget([
									'items' => [
										[
											...
											'url' => ArrayHelper::merge(Yii::$app->request->get(), ['/vat/edit', 'id' => $model->id]),
										],
										[
											'label' => Yii::t('backend.view', 'Delete'),
											'url' => ArrayHelper::merge(Yii::$app->request->get(), ['/vat/delete', 'id' => $model->id]),
											'linkOptions' => [
												'data' => [
													'toggle' => 'confirm',
													'confirm-post' => true,
													'confirm-text' => Yii::t('backend.view', 'Are you sure you want to delete this VAT?'),
