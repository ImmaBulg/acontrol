...
$this->params['breadcrumbs'][] = [
	...
	'url' => ['/rule-fixed-load/list', 'id' => $model->tenant_id],
];
$this->params['breadcrumbs'][] = $model->getAliasUseType()."/".$model->getAliasUseFrequency();
$this->title = Yii::t('backend.view', 'Rule - {name}', [
	'name' => $model->getAliasUseType()."/".$model->getAliasUseFrequency(),
]);
?>
