...
$this->title = Yii::t('backend.view', 'Create a new group load rule');
...
$this->params['breadcrumbs'][] = Yii::t('backend.view', 'Create a new group load rule');
?>
<h1 class="page-header"><?php echo $this->title; ?></h1>
<div class="well">
	<?php $form_active = ActiveForm::begin([
		'id' => 'form-group-load-rule-create',
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<?php echo $form_active->field($form, 'usage_tenant_group_id', [
						...
						'data' => RuleGroupLoad::getListTenantGroups($model->site_id),
					])->label($form->getAttributeLabel('usage_tenant_group_id'). ' ' .Html::a(Yii::t('backend.view', '(Add tenant group)'), ['/site/tenant-group-create', 'id' => $model->site_id], ['target' => '_blank'])); ?>
			...
			<div class="row">
				<div class="col-lg-3" style="display:none;" data-use-type="<?php echo RuleGroupLoad::USE_TYPE_SINGLE_METER_LOAD; ?>">
					<?php echo $form_active->field($form, 'meter_id')->widget(Select2::classname(), [
						'data' => Meter::getAirListMeters($model->site_id),
					]); ?>
				</div>
				<div class="col-lg-3" style="display:none;" data-use-type="<?php echo RuleGroupLoad::USE_TYPE_SINGLE_METER_LOAD; ?>">
				...
				<div class="col-lg-3" style="display:none;" data-use-type="<?php echo RuleGroupLoad::USE_TYPE_SINGLE_METER_GROUP_LOAD; ?>">
					<?php echo $form_active->field($form, 'channel_group_id')->widget(Select2::classname(), [
						'data' => RuleGroupLoad::getListChannelGroups($model->site_id),
					])->label($form->getAttributeLabel('channel_group_id'). ' ' .Html::a(Yii::t('backend.view', '(Add channel group)'), ['/site/meter-channel-group-create', 'id' => $model->site_id], ['target' => '_blank'])); ?>
				</div>
				<div class="col-lg-3" style="display:none;" data-use-type="<?php echo RuleGroupLoad::USE_TYPE_SINGLE_TENANT_GROUP_LOAD; ?>">
					<?php echo $form_active->field($form, 'tenant_group_id')->widget(Select2::classname(), [
						'data' => RuleGroupLoad::getListTenantGroups($model->site_id),
					])->label($form->getAttributeLabel('tenant_group_id'). ' ' .Html::a(Yii::t('backend.view', '(Add tenant group)'), ['/site/tenant-group-create', 'id' => $model->site_id], ['target' => '_blank'])); ?>
				</div>
			</div>
