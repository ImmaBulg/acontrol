...
use backend\widgets\site\SiteScheduleWidget;
use backend\widgets\task\TaskWidget;
use backend\widgets\meter\MeterRawDataLastScheduleWidget;

$this->title = Yii::t('backend.view', 'Dashboard');
?>
<!--<h1 class="page-header">--><?php //echo $this->title; ?><!--</h1>-->
<!---->
<?php //if (Yii::$app->user->can('DashboardWidget.TaskWidget')): ?>
<!--	<div class="row">-->
<!--		--><?php //if (Yii::$app->user->can('DashboardWidget.TaskWidget')): ?>
<!--			<div class="col-lg-12">-->
<!--				--><?php //echo TaskWidget::widget();?>
<!--			</div>-->
<!--		--><?php //endif; ?>
<!--	</div>-->
<?php //endif; ?>
<!---->
<?php //if (Yii::$app->user->can('DashboardWidget.SiteScheduleWidget')): ?>
<!--	<div class="row">-->
<!--		<div class="col-lg-12">-->
<!--			--><?php //echo SiteScheduleWidget::widget(); ?>
<!--		</div>-->
<!--	</div>-->
<?php //endif; ?>
...
use backend\assets\admin\dashboard\DashboardAsset;

DashboardAsset::register($this);


$this->title = "DASHBOARD | JINNILOTTO";
?>
