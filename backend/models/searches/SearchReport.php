...
{
	public $modelClass = '\backend\models\searches\models\Report';
		...
		return [
			...
			'attributes' => [
				...
				'is_automatically_generated' => [
					'asc' => ['is_automatically_generated' => SORT_ASC],
					'desc' => ['is_automatically_generated' => SORT_DESC],
				],
				'level' => [
					'asc' => ['level' => SORT_ASC],
				...
				'issued_by' => [
					'asc' => [
						'issued.name' => SORT_ASC,
					],
					'desc' => [
						'issued.name' => SORT_DESC,
					],
				],
			],
		];
			...
			foreach ($filters as $attribute => $value) {
				if ($value != null) {
					switch ($attribute) {
						 ...
						 */
						case 'is_automatically_generated':
							$query->andFilterWhere(["$t.is_automatically_generated" => $value]);
							break;
						 ...
						 */
						case 'issued_by':
							$query->andFilterWhere(['like', 'issued.name', $value]);
							break;
