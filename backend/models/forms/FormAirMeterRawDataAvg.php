 ...
 */
class FormAirMeterRawDataAvg extends \yii\base\Model
{
	...
	public function getAvgData()
	{
		if ($this->period_from != null && $this->period_to != null && $this->from_date != null && $this->to_date != null) {
			...
			return AirMeterRawData::getAvgData($this->_meter_id, $this->_channel_id, $period_from, $period_to, $from_date, $to_date);
		}
	}
}
