	...
	var methods = {
		init : function(options) {
			var o = {
				...
				labelRightAddOne: '<i class="glyphicon glyphicon-arrow-right"></i>',
				labelRightAddAll: '<i class="glyphicon glyphicon-forward"></i>',
				labelRightRemoveOne: '<i class="glyphicon glyphicon-arrow-left"></i>',
				labelRightRemoveAll: '<i class="glyphicon glyphicon-backward"></i>',
				labelLeftAddOne: '&lsaquo;',
				labelLeftAddAll: '&laquo;',
				labelLeftRemoveOne: '&rsaquo;',
				labelLeftRemoveAll: '&raquo;',

				maxSelected: -1,
				autoSort: false,
				autoSortAvailable: false,
				search: true,
				searchInput: '<input type="text" class="form-control input-sm" />',
				caseSensitive: false,
				delay: 200,
			...
			return this.each(function () {
				...
				if (o.search != false && o.optGroupSearch != false) {
					var ss = 
						...
						"<input class='small' type='text' /><a href='#'> </a>";
				...
				else if (o.search != false && o.searchInput != false) {
					var	ss = o.searchInput;
				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							...
							?
							("<p class='AddOne' title='Add Selected'>" +o.labelRightAddOne+ "</p>" +
							"<p class='AddAll' title='Add All'>" +o.labelRightAddAll+ "</p>" +
							"<p class='RemoveOne' title='Remove Selected'>" +o.labelRightRemoveOne+ "</p>" +
							"<p class='RemoveAll' title='Remove All'>" +o.labelRightRemoveAll+ "</p>")
							:
							("<p class='AddOne' title='Add Selected'>" +o.labelLeftAddOne+ "</p>" +
							"<p class='AddAll' title='Add All'>" +o.labelLeftAddOne+ "</p>" +
							"<p class='RemoveOne' title='Remove Selected'>" +o.labelLeftAddOne+ "</p>" +
							"<p class='RemoveAll' title='Remove All'>" +o.labelLeftAddOne+ "</p>")
							) +
						"</div>" +
						"<div class='ms2side__select'>" +
