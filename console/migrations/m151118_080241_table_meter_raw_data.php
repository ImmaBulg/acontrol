...
class m151118_080241_table_meter_raw_data extends \common\components\db\Migration
{
	public function up()
	{
		...
		$this->createTable('meter_raw_data', [
			'id' => Schema::TYPE_PK,
			'meter_id' => Schema::TYPE_STRING . ' NOT NULL',
			'channel_id' => Schema::TYPE_STRING . ' NOT NULL',
