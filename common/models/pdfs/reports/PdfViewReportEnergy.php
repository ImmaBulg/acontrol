...
/**
 * PdfViewReportEnergy is the class for view report energy pdf.
 */
class PdfViewReportEnergy extends PdfView
{
	/**
	 * @inheritdoc
	 */
	...
	{
		$view = Yii::$app->getView()->render('@common/views/report/pdf/energy/view', $this->getParams());
		return $view;
	}
	...
	public function getDefaultOptions()
	{
		return [
			...
			'options' => [
				'title' => Yii::t('common.view', 'Energy report'),
			],
			'cssInline' => '@page{
