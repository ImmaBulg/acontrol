...
/**
 * PdfViewReportNisPerSite is the class for view report nis per site pdf.
 */
class PdfViewReportNisPerSite extends PdfView
{
	/**
	 * @inheritdoc
	 */
	...
	{
		$view = Yii::$app->getView()->render('@common/views/report/pdf/nis-per-site/nis-per-view', $this->getParams());
		return $view;
	}
	...
	public function getDefaultOptions()
	{
		return [
			...
			'options' => [
				'title' => Yii::t('common.view', 'Financial report'),
			],
			'cssInline' => '@page{
