...
class Site extends ActiveRecord
{
	...
	public static function getListUsers()
	{
        ...
        if(!Yii::$app->user->can('ReportController.actionCreate')) {
            ...
            } elseif (Yii::$app->user->can('ReportController.actionCreateSiteOwner')) {
            ...
            } elseif (Yii::$app->user->can('SiteController.actionReportsSiteOwner')) {
	...
	{
		return (new Query())->select(['ip_address'])->from(SiteIpAddress::tableName())->where(['site_id' => $site_id])->indexBy('ip_address')->column();
	}
