...
class Report extends ActiveRecord
{
	 ...
	 */
	public function generatePdf(array $data, array $additional_parameters = [])
	{
		...
		switch ($this->type) {
			...
			case Report::TYPE_METERS:
				$view = new PdfViewReportMeters();
				break;

			case Report::TYPE_SUMMARY:
				$view = new PdfViewReportSummaryPerSite();
				break;

			case Report::TYPE_RATES_COMPRASION:
				$view = new PdfViewReportRatesComprasion();
				break;

			case Report::TYPE_ENERGY:
				$view = new PdfViewReportEnergy();
				break;

			case Report::TYPE_YEARLY:
				$view = new PdfViewReportYearly();
				break;
	 ...
	 * @param array $additional_parameters
	 */
	public function generateExcel(array $data, array $additional_parameters = [])
	{
		$prefix = Yii::$app->language;
		$language = Report::getReportLanguage();
		Yii::$app->language = $language;
		...
		switch ($this->type) {
			...
			case Report::TYPE_METERS:
				$view = new \common\models\excels\reports\ExcelViewReportMeters();
				break;

			case Report::TYPE_SUMMARY:
				$view = new \common\models\excels\reports\ExcelViewReportSummaryPerSite();
				break;

			case Report::TYPE_RATES_COMPRASION:
				$view = new \common\models\excels\reports\ExcelViewReportRatesComprasion();
				break;

			case Report::TYPE_ENERGY:
				$view = new \common\models\excels\reports\ExcelViewReportEnergy();
				break;

			case Report::TYPE_YEARLY:
				$view = new \common\models\excels\reports\ExcelViewReportYearly();
				break;
