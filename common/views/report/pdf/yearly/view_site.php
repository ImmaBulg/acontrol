...
<table dir="<?php echo $direction; ?>" style="width:100%;font-size:12px;color:#000;vertical-align:top;margin-bottom:20px;" cellpadding="0" cellspacing="0">
	<tbody>
		...
		<tr>
			<td style="padding:5px;width:60%">
				<?php echo Yii::t('common.view', 'Yearly summary report for site'); ?>:
			</td>
			<td style="padding:5px;">
				<?php echo $site->name; ?>
			</td>
...
<?php if(!empty($data['data'])): ?>
		<table dir="<?php echo $direction; ?>" style="border-collapse:collapse;width:100%;font-size:11px;color:#000;vertical-align:top;margin-bottom:20px;" cellpadding="0" cellspacing="0">
			...
			<tbody>
				...
				?>
				<?php foreach($data['data'] as $date => $row): ?>
					<?php
					...
					<tr>
						...
						<td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
                            <?php
                                ...
                                elseif (CalculationHelper::isCorrectFixedPayment($additional_parameters['rates_fixed_payments_all'])) //rate
                                {
				...
				<tr>
					...
					<td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
						<?php echo Yii::$app->formatter->asNumberFormat($data['pisga_consumption']); ?>
					</td>
					<td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
						<?php echo Yii::$app->formatter->asNumberFormat($data['geva_consumption']); ?>
					</td>
					<td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
						<?php echo Yii::$app->formatter->asNumberFormat($data['shefel_consumption']); ?>
					</td>
					<td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
						<?php echo Yii::$app->formatter->asNumberFormat($data['total_loads_consumption']); ?>
					</td>
					<td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
						<?php echo Yii::$app->formatter->asNumberFormat($data['total_extras_consumption']); ?>
					</td>
					<td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
						<?php echo Yii::$app->formatter->asNumberFormat($data['total_consumption']); ?>
					</td>
					<td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
						<?php echo Yii::$app->formatter->asNumberFormat($data['total_extras_pay']); ?>
					</td>
                    ...
                    <td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
						<?php
                            // #uncomment
                            //echo Yii::$app->formatter->asNumberFormat($data['fixed_payment']);
					...
					<td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
						<?php
                            // #uncomment
                            //echo Yii::$app->formatter->asNumberFormat($data['total_pay'] + $data['fixed_payment']);
                            echo Yii::$app->formatter->asNumberFormat($data['total_pay'] + $_total_fixed_payment);
                        ?>
					</td>
                    <td style="padding:5px;border:1px solid #000;" align="center" dir="ltr">
                        <?php echo Yii::$app->formatter->asNumberFormat($data['max_consumption']); ?>
                    </td>
				</tr>
			</tbody>
		</table>
