		...
		<div id="main">
			<div class="container">
                ...
                <div class="col-lg-12">
					...
					<?php $pointStartIa = ArrayHelper::getValue($realtime, 'incoming_temp.0.date', []);
					?>
						...
						'clientOptions' => [
							...
							'series' => [
								[
									...
									'fillOpacity' => 0.2,
									'tooltip' => ['valueSuffix' => ' ' .Yii::t('frontend.view', 'A')],
									'pointStart' => new JsExpression('Date.UTC("' . $pointStartIa .'")'),
									'data' => array_values(ArrayHelper::map(ArrayHelper::getValue($realtime, 'incoming_temp', []), function($item) {
